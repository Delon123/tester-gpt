...
async function handleSendMessage() {
  ...
  try {
    ...
    // PERBAIKAN: Ganti Ollama error message menjadi OpenRouter
    aiMsg.innerHTML = 'Error: Could not connect to the OpenRouter model. Please check your API Key and network connection.';
    overlay.style.display = 'none';
  }
}
